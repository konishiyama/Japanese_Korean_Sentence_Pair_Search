...
original_filename = "deduplicated_final"
...
os.makedirs(original_filename + "_split", exist_ok=True)
...
for i in range(0, total_elements, batch_size):
    ...
    # Create a split file
    split_filename = f"{original_filename}_split/split_{i // batch_size + 1}.json"
