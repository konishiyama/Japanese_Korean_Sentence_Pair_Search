    ...
    <main>
      <div className="justify-center items-center mx-auto text-base sm:w-4/5">
        ...
        <div className=''>
          ...
          <p className='mb-6 sm:mb-8'>日本語・韓国語の対訳文章75万ペア（2023年11月時点）を収録しています。用例を確かめたいキーワードを検索欄に入力し、簡単に例文を検索することができます。</p>
        ...
        <div className='text-center mt-16'>
          <a 
            ...
            className="font-semibold hover:text-purple-400"> ko.nishiyama.0420@gmail.com
            </a>
        </div>
      </div>
    </main>
